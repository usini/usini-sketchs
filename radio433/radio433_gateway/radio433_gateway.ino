 //usini radio433_gateway
// By Rémi Sarrailh
// MIT licence
// version: 1.2

// Get this program / update at: https://github.com/usini-sketches
//
...
void sendInfo() {
  Serial.print("{\"file\":\"radio433_gateway\",\"url\":\"github.com/usini/usini-sketches\",\"ver\":\"");
  Serial.print(VER);
